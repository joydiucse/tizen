...
;(function($) {
  ...
  function exclude(elemList, excludedElem) {
    ...
    for (var i = 0, index; i < excludedElem.length; i++) {
      ...
      //$("a").removeClass("getCentered");
	  //$("a").eq(index+1).addClass("getCentered");
      
  	//index = $("a").find(":focus").index();
	//console.log(index);
  ...
  function getSectionLastFocusedElement(sectionId) {
    ...
    //console.log(lastFocusedElement, sectionId);
  ...
  function onKeyDown(evt) {
    // alert(evt.keyCode)
	  ...
	  //tizen.tvaudiocontrol.setVolume(70);  
	 

    // Dropdown Menu start
     $("section#banner .slick-list a").focus(function(){
        $('#myDropdown2').removeClass('show2');
        $(".dropbtn2").css("border", "2px solid transparent");
     });
    ...
    $(".dropbtn2").focus(function()
    {
        var isFocused = $(this).is(":focus");
        if(isFocused)
        {
          document.getElementById("myDropdown2").classList.toggle("show2");
          $('#myDropdown2').addClass('show2');
          $(".dropbtn2").css("border", "2px solid #fff");
        }
        else
        {
          $('#myDropdown2').removeClass('show2');
...
// Dropdown Menu End
		...
		var checkIsFocused = $(".slick-slide").hasClass("currentFocus");
		//console.log(checkIsFocused);

		if((evt.keyCode==38 || evt.keyCode==40) && checkIsFocused==true)
		{
			//$(".slick-slider-custom .slick-slide").removeClass('currentFocus');
			
			//console.log(checkIsFocused);
		}
		else if((evt.keyCode==38 || evt.keyCode==40) && checkIsFocused==false)
		{
			 //$(".slick-slider-custom .slick-slide").attr('data-slick-index', 0).addClass('currentFocus');
       //$(".nav__item__link").blur(); 
		}
		
	    var currentSectionId = getSectionId($(getCurrentFocusedElement()));
	    ...
	    $(":focus").each(function(index, value) {
	    	
	    	//alert("Focused index = "+ index );
	    ...
	    */
        ...
        //alert("Focused sss = "+ nextInput );
		
		  $('.slick-slider-custom').on('afterChange', function(event, slick, currentSlide, nextSlide){
			  //alert(currentSlide);

        $('#myDropdown2').removeClass('show2');


        //console.log($('.slick-slider-custom.slick-active').attr('class'));

			  	//if(evt.keyCode==38 && evt.keyCode==40)
				//{
					//$(".slick-slider-custom .slick-active").removeClass('currentFocus');
				//}

			  		//console.log( $(".slick-slider-custom .slick-slide").length-1);
			  
			  		//console.log(nextSlide);
			  		/*
			  		var totalSlide = $(".slick-slider-custom .slick-slide").length-1;
			  		
			  		if(totalSlide != currentSlide)
		  			{
			  			$(".slick-slider-custom .slick-active").removeClass('currentFocus');
			  			$(".slick-slider-custom .slick-active").attr('data-slick-index', currentSlide).addClass('currentFocus');
		  			}
			  		
			  		if(totalSlide == currentSlide)
		  			{
			  			$(".slick-slider-custom .slick-slide").attr('data-slick-index', totalSlide).addClass('currentFocus');
		  			}
			  		*/
			  
			  		//if((evt.keyCode==38 && evt.keyCode==40) && (totalSlide == currentSlide))
					//{
			  			// $(".slick-slider-custom .slick-slide").removeClass('currentFocus');
						//$(".slick-slider-custom .slick-active").removeClass('currentFocus');
					//}
		...
		//for Keyboard manage
		if($(getCurrentFocusedElement()).attr('title') == 'search' && evt.keyCode==13)
		{
			document.getElementById("input").focus();
			console.log("Click Focus.");
		}
	  	//if(document.getElementById("input").value.length > 0 && evt.keyCode==65376)
		else if(evt.keyCode==65376)
		{
		  //console.log("Click Search Function.");
		  $(".searchBox").focus();			 
		}

	  //for Keyboard manage
		if(evt.keyCode==65385)
		{
		...
		//for Back button manage
		if(evt.keyCode==10009 || evt.keyCode == 111)
		{
          var staticBackdrop=document.getElementById("staticBackdrop").classList;
            if(staticBackdrop.contains('show')){
              $('#staticBackdrop').modal('hide');
            }else if(document.querySelector("app-search").style.display=="block"){
              window.scrollTo(0, 0);
    ...
    // }
		...
		if(evt.keyCode==38)
		{
			var isVisibleModal = $('#Mymodal').is(':visible');  
			if(isVisibleModal)
			{
				setTimeout(function() {
		          	$(".btn-go-back").focus();
	  ...
	  audio_obj.src = '../assets/sound/Keyboard-single-button-presses.mp3'; 
	  ...
	  //console.log(getCurrentFocusedElement())
	  
	  //console.log($(getCurrentFocusedElement()).parent().parent().parent().parent().attr('title'), evt.keyCode);
	  
		  
		if($(getCurrentFocusedElement()).parent().parent().parent().parent().attr('title') != undefined && evt.keyCode==40) 
	  	{
			const elementRect = $(getCurrentFocusedElement()).parent().parent().parent().parent().offset();
			window.scrollTo(0, elementRect.top-150, 'smooth');
	  	}
		
		else if($(getCurrentFocusedElement()).parent().parent().parent().parent().attr('title') != undefined && $(getCurrentFocusedElement()).parent().parent().parent().parent().attr('title') != "linearTvWrapper" && evt.keyCode==38 ) 
	  	{
			const elementRect = $(getCurrentFocusedElement()).parent().parent().parent().parent().offset();
			window.scrollTo(0, elementRect.top-550, 'smooth');
	  	}
		
		else if($(getCurrentFocusedElement()).parent().parent().parent().parent().attr('title') == "linearTvWrapper" && evt.keyCode==38) 
	  	{
			const elementRect = $(getCurrentFocusedElement()).parent().parent().parent().parent().offset();
			window.scrollTo(0, elementRect.top-70, 'smooth');
	  	}
    ...
    makeFocusable: function(sectionId) {
      ...
      if (sectionId) {
        if (_sections[sectionId]) {
          ...
          //console.log(_sections[sectionId]);
        } else {
          throw new Error('Section "' + sectionId + '" doesn\'t exist!');
        }
      } else {
        for (var id in _sections) {
          ...
          //console.log(_sections[id].selector);
        }
      }
    },
